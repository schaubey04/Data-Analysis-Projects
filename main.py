...
root=Tk()
root.title("Heart attck Prediction System")
...
def analysis():
    ...
    #checking all are working or not 
    print("A is age :" ,A)
    print("B is gender :" ,B)
    print("C is cp :" ,C)
...
#first graph<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    Canvas._tkcanvas.place(width=250,height=250,x=600,y=225)
...
############## Second Graph<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    Canvas2._tkcanvas.place(width=250,height=250,x=860,y=225)
...
cp_combobox=Combobox(Detail_entry,values=["0=typical angina","1=atypical angina","2= non-anginal pain"
                                          ,"3= asymptomatic"],font="arila 12",state="r",width=14)

restecg_combobox=Combobox(Detail_entry,values=["0","1","2"],font="arila 12",state="r",width=11)

slope_combobox=Combobox(Detail_entry,values=["0= upsloping","1= flat","2= downsloping"],font="arila 12"
                        ,state="r",width=12)

ca_combobox=Combobox(Detail_entry,values=["0","1","2","3","4"],font="arila 12",state="r",width=14)

thal_combobox=Combobox(Detail_entry,values=["0","1","2","3"],font="arila 12",state="r",width=14)
...
report=Label(root, font="arial 25 bold",bg="white",fg="#8dc63f") #Yellow Green
...
######################## Smoking and Non-Smoking Button########################## 12
button_mode=True
choice="smoking"
def changemode():
    global button_mode
